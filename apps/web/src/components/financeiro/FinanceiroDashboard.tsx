  ...
  return (
    <div className="k-page financeiro-v2 flex flex-col gap-6">
      <header className="k-page-header k-finance-header">
        <div className="mr-auto text-left lg:col-start-1 xl:col-start-1 mr-auto text-left lg:col-start-1 xl:col-start-1">
<h1 className="text-[28px] font-semibold tracking-[-0.045em] text-slate-100">
            Financeiro.
          </h1>
            ...
            {entries.map((entry) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`k-number text-left text-sm font-semibold ${
                      entry.value < 0
                        ? "text-rose-200"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
          <section className="k-modal max-h-[92vh] w-full max-w-4xl overflow-y-auto p-5">
            ...
            <form onSubmit={handleSaveEdit} className="grid gap-4 xl:grid-cols-2">
              ...
              <div className="flex flex-wrap justify-start gap-3 xl:col-span-2">
                <button
                  type="button"
                  onClick={closeEdit}
